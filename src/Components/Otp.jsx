    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: "1170px" }}>
        <Card className="my-5" style={{ border: " 1px solid #D7242A" }}>
          <h3
            className="mt-5"
            style={{ color: "#D7242A", textAlign: "center" }}
          >
            Please enter the one-time password <br /> to verify
          </h3>
          <p
            style={{ color: "#565656", fontSize: "30px", textAlign: "center" }}
          >
            A code has been sent to *******621
          </p>
          <OtpInput
            value={otp}
            onChange={setOtp}
          ...
          />
          <p
            style={{ color: "#565656", fontSize: "20px", textAlign: "center" }}
          >
            Resend One-Time Password
          </p>
          <div className="d-flex justify-content-center mt-5 mb-4">
            <button type="button" className="buttonotp">
              Validate
            </button>
            <div>
              <ToastContainer />
