...
function Lease() {
    ...
    const shouldDisplayButton = propertyData.approved === undefined;
                        ...
                        {shouldDisplayButton && !isActionTaken && (
                            <div className="row" style={{ marginBottom: '10%' }}>
                                <div className="col d-flex justify-content-end">
                                    <button className='btn btn-outline-danger m-2' onClick={() => approvereject('reject', id)} style={{width:'200px'}} >Reject</button>
                                    <button className='btn btn-success m-2' onClick={() => approvereject('approve', id)}  style={{width:'200px'}}>Approve</button>
